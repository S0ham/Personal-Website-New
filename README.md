...
### Your resume
The nav has a **Resume ↓** tab on every page (and a download card on Contact). It points to `resume.pdf` in the repo — currently a placeholder. Upload your real resume with the exact filename `resume.pdf` (lowercase) to replace it.
